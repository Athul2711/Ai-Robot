...
def read_emotion_from_file():
    ...
    url = "http://192.168.82.53/shared_data.txt"  # Replace with the URL you want to request
    string_from_url = http_get_string(url)
    return string_from_url

def read_state_from_file():
    url = "http://192.168.82.53/status.txt"  # Replace with the URL you want to request
    string_from_url = http_get_string(url)
    return string_from_url
